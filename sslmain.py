...
class TicTacToe:
    ...
    def host_game(self, host, port, ssl_cert_path, ssl_key_path):
        ...
        context.set_ciphers('DEFAULT@SECLEVEL=2')  # Adjust the security level as needed
        ...
        threading.Thread(target=self.handle_connection, args=(ssl_client,)).start()
        server.close()
...
game = TicTacToe()
game.host_game("192.168.29.27", 9999, "server-signed-cert1.pem", "server-key.pem")